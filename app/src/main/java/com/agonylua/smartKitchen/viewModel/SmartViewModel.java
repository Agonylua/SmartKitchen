...
import com.agonylua.smartKitchen.dto.RuleAction;
import com.agonylua.smartKitchen.dto.RuleCondition;
import com.agonylua.smartKitchen.model.DeviceMode;
import com.agonylua.smartKitchen.model.DeviceStatus;
...
public class SmartViewModel extends ViewModel {
    ...
    @Inject
    public SmartViewModel(SmartRepository repository) {
