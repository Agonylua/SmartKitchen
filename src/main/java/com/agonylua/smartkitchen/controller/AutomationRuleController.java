...
import com.agonylua.smartkitchen.service.SceneExecutionRules;
...
public class AutomationRuleController {
    ...
    @Autowired
    private SceneExecutionRules sceneExecutionRules;
    ...
    public ApiResponse<Boolean> executeScene(@RequestParam String ruleMode) {
        ...
        String userId = SecurityUtils.getCurrentUserId();
        return ApiResponse.success(sceneExecutionRules.executeManualScene(userId, ruleMode));
    }
}